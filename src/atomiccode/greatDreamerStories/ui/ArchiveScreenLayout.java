...
public class ArchiveScreenLayout {
    ...
    public ArchiveScreenLayout(UiLayoutContext context) {
    ...
    public static ArchiveScreenLayout fromViewport(int viewportWidth, int viewportHeight) {
        return new ArchiveScreenLayout(new UiLayoutContext(viewportWidth, viewportHeight));
    }
